	...
	<div class="container">
		<div class='row'>
			...
			<div class="col-md-8 form-register-container card-academic" style="padding: 30px; margin-top: 50px; margin-bottom: 50px;">
				<h2 class="mb-4">Data Barang Dipinjam</h2>
				<table class="table table-bordered table-super-condensed">
					...
					<tbody>
						<?php
							include 'config.php';
							$query = mysqli_query($conn, "SELECT * FROM tbl_pinjam WHERE peminjam='$username'");
							...
							?>
									<tr>
										...
										<td>
											<a href="proses-kembalikan.php?id=<?php echo $data['id'];?>" class="btn btn-primary-academic btn-sm">
